<!DOCTYPE html>
<!-- saved from url=(0066)http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html -->
<html lang="en">
...
<head>
    ...
    <link rel="alternate stylesheet" type="text/css" href="{{ asset('assets/switcher/css/purple.css') }}"
        title="purple" media="all" disabled="">

    <!-- Fav and touch icons -->
    <link rel="apple-touch-icon-precomposed" sizes="144x144"
        href="http://themes.webmasterdriver.net/carforyou/demo/assets/images/favicon-icon/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114"
        href="http://themes.webmasterdriver.net/carforyou/demo/assets/images/favicon-icon/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72"
        href="http://themes.webmasterdriver.net/carforyou/demo/assets/images/favicon-icon/apple-touch-icon-72-precomposed.png">
    <link rel="apple-touch-icon-precomposed"
        href="http://themes.webmasterdriver.net/carforyou/demo/assets/images/favicon-icon/apple-touch-icon-57-precomposed.png">
    <link rel="shortcut icon"
        href="http://themes.webmasterdriver.net/carforyou/demo/assets/images/favicon-icon/favicon.png">
    <!-- Google-Font-->
...
<body>
                    ...
                    <div class="col-sm-9 col-md-10">
                        ...
                        <div class="header_info">
                            ...
                            <div class="login_btn"> <a href="#loginform" class="btn btn-xs uppercase"
                                    data-bs-toggle="modal" data-bs-dismiss="modal">Login / SignUp</a> </div>
                ...
                <div class="row header-row desktop">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown"><a href="#" id="dropdownMenuButton1"
                            ...
                            <li class="dropdown"><a href="#" id="dropdownMenuButton2"
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="listing-detail-3.html">Detail Page Style 3</a></li>
                            ...
                            <li class="dropdown"><a href="#" id="dropdownMenuButton3"
                            ...
                            <li class="dropdown"><a href="#" id="dropdownMenuButton4"
                            ...
                            <li class="dropdown"><a href="#" id="dropdownMenuButton5"
                            ...
                            <ul>
                                ...
                                <li class="dropdown dropdown-toggle"> <a href="#" class="dropdown-toggle"
                                        id="dropdownMenuButton6" data-bs-toggle="dropdown" aria-expanded="false"><i
                                            class="fa fa-user-circle" aria-hidden="true"></i> John Anderson <i
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton6">
                                        ...
                                        <li><a class="dropdown-item" href="profile-settings.html">Profile Settings</a>
                                        </li>
                    ...
                    <div class="col-10 col-md-8 right">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent1">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown"><a href="#" id="dropdownMenuButton8"
                                        data-bs-toggle="dropdown" aria-expanded="false">Home</a>
                                ...
                                <li class="dropdown"><a href="#" id="dropdownMenuButton9"
                                        data-bs-toggle="dropdown" aria-expanded="false">Inventory</a>
                                ...
                                <ul>
                                    ...
                                    <li class="dropdown dropdown-toggle"> <a href="#" class="dropdown-toggle"
                                            ...
                                            aria-expanded="false"><i class="fa fa-user-circle"
                                                aria-hidden="true"></i> John Anderson <i class="fa fa-angle-down"
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton13">
                                            ...
                                            <li><a class="dropdown-item" href="profile-settings.html">Profile
                                                    Settings</a></li>
                                            ...
                                            <li><a class="dropdown-item" href="post-vehicle.html">Post a Vehicle</a>
                                            </li>
        ...
        <div class="container">
            ...
            <form action="#" method="get">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4 col-sm-4 black_input">
                    ...
                    <div class="form-group col-md-2 col-sm-6">
                        <button type="submit" class="btn btn-block search"><i class="fa fa-search"
                                aria-hidden="true"></i> Search Car </button>
                    </div>

                    <div class="form-group col-md-2 col-sm-6">
                        <button type="button" class="btn btn-block search" href="#advancedSearchModal"
                            data-bs-toggle="modal" data-bs-dismiss="modal"><i class="fa fa-search-plus"
                                aria-hidden="true"></i> Advanced Search </button>
                    </div>

                    <div class="form-group col-md-2 input_col2_wp">
                        <button type="button" class="btn btn-block form-control text-white" id="from_reset"><i
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-6">
                    ...
                    <div class="looking-car">
                        ...
                        <div class="looking-cat-image"> <img src="assets/images/looking-used-car.png"
                                alt="Image" /> </div>
                        ...
                        <div class="looking-car-content">
                            ...
                            <a href="" class="btn">View Listing<i class="fa fa-chevron-circle-right"
                                    aria-hidden="true"></i></a>
                        </div>
                ...
                <div class="col-lg-6 col-sm-6">
                    ...
                    <div class="looking-car">
                        ...
                        <div class="looking-cat-image"> <img src="assets/images/looking-new-car.png"
                                alt="Image" /> </div>
                ...
                <div class="recent-tab">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link active" id="home-tab"
                                ...
                                aria-selected="true">New Car</a></li>
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link" id="profile-tab"
                                ...
                                aria-selected="false">Use Car</a></li>
                    ...
                    <div class="tab-pane fade show active" id="home" role="tabpanel"
                        ...
                        <div class="col-list-3">
                            ...
                            <div class="recent-car-list">
                                ...
                                <div class="car-info-box"> <a href="#"><img
                                            src="assets/images/recent-car-1.jpg" class="img-fluid"
                                            alt=""></a>
                                    ...
                                    <ul>
                                        ...
                                        <li><i class="fa fa-calendar" aria-hidden="true"></i>2023 Model</li>
                        ...
                        <div class="col-list-3">
                            ...
                            <div class="recent-car-list">
                                ...
                                <div class="car-info-box"> <a href="#"><img
                                            src="assets/images/recent-car-2.jpg" class="img-fluid"
                                            alt=""></a>
                                    ...
                                    <ul>
                                        ...
                                        <li><i class="fa fa-calendar" aria-hidden="true"></i>2022 Model</li>
                        ...
                        <div class="col-list-3">
                            ...
                            <div class="recent-car-list">
                                ...
                                <div class="car-info-box"> <a href="#"><img
                                            src="assets/images/recent-car-3.jpg" class="img-fluid"
                                            alt=""></a>
                        ...
                        <div class="col-list-3">
                            ...
                            <div class="recent-car-list">
                                ...
                                <div class="car-info-box"> <a href="#"><img
                                            src="assets/images/recent-car-4.jpg" class="img-fluid"
                                            alt=""></a>
                        ...
                        <div class="col-list-3">
                            ...
                            <div class="recent-car-list">
                                ...
                                <div class="car-info-box"> <a href="#"><img
                                            src="assets/images/recent-car-5.jpg" class="img-fluid"
                                            alt=""></a>
                        ...
                        <div class="col-list-3">
                            ...
                            <div class="recent-car-list">
                                ...
                                <div class="car-info-box"> <a href="#"><img
                                            src="assets/images/recent-car-6.jpg" class="img-fluid"
                                            alt=""></a>
                                ...
                                <div class="car-info-box"> <a href="#"><img
                                    ...
                                    <div class="compare_item">
                                        ...
                                        <div class="checkbox">
                                            ...
                                            <label for="compare90">Compare</label>
            ...
            <div class="row">
                ...
                <div class="col-list-3">
                    ...
                    <div class="featured-car-list">
                        ...
                        <div class="featured-car-img"> <a href=""><img src="assets/images/featured-img-01.jpg"
                ...
                <div class="col-list-3">
                    ...
                    <div class="featured-car-list">
                        ...
                        <div class="featured-car-img"> <a href=""><img src="assets/images/featured-img-02.jpg"
                                    class="img-fluid" alt="Image"></a>
                ...
                <div class="col-list-3">
                    ...
                    <div class="featured-car-list">
                        ...
                        <div class="featured-car-img"> <a href=""><img src="assets/images/featured-img-03.jpg"
                                    class="img-fluid" alt="Image"></a>
                ...
                <div class="col-lg-12">
                    ...
                    <div id="trending_slider">
                        ...
                        <div class="trending-car-m">
                            ...
                            <div class="trending-car-img"> <img src="assets/images/trending-car-img-1.jpg"
                        ...
                        <div class="trending-car-m">
                            ...
                            <div class="trending-car-img"> <img src="assets/images/trending-car-img-2.jpg"
                                    alt="Image" class="img-fluid" /> </div>
                        ...
                        <div class="trending-car-m">
                            ...
                            <div class="trending-car-img"> <img src="assets/images/trending-car-img-3.jpg"
                                    alt="Image" class="img-fluid" /> </div>
            ...
            <div class="row">
                ...
                <div id="testimonial-slider">
                    ...
                    <div class="testimonial-m">
                        ...
                        <div class="testimonial-img"> <img src="assets/images/testimonial-img-1.jpg"
                                alt="images" /> </div>
                    ...
                    <div class="testimonial-m">
                        ...
                        <div class="testimonial-img"> <img src="assets/images/testimonial-img-2.jpg"
                                alt="images" /> </div>
                    ...
                    <div class="testimonial-m">
                        ...
                        <div class="testimonial-img"> <img src="assets/images/testimonial-img-3.jpg"
                                alt="images" /> </div>
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <article class="blog-list">
                        ...
                        <div class="blog-info-box">
                            ...
                            <a href="blog-detail.html"><img src="assets/images/blog_img1.jpg" class="img-fluid"
                                    alt="image"></a>
                            ...
                            <ul>
                                ...
                                <li><a href="#"><i class="fa fa-tags" aria-hidden="true"></i>Latest Cars</a>
                                </li>



                                <li><i class="fa fa-calendar" aria-hidden="true"></i>15 Jan 2023</li>



                                <li><a href="#"><i class="fa fa-comment-o" aria-hidden="true"></i>10
                                        Comments</a></li>
                        ...
                        <div class="blog-content">
                            ...
                            <h5><a href="blog-detail.html">But I must explain to you how all this mistaken idea.</a>
                            </h5>



                            <p>expound the actual teachings of the great explorer of the truth, the master-builder of
                                human happiness. No one rejects, dislikes, or avoids pleasure itself, because</p>



                            <a href="blog-detail.html" class="btn-link">Read More <i class="fa fa-long-arrow-right"
                                    aria-hidden="true"></i></a>
                        </div>
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <article class="blog-list">
                        ...
                        <div class="blog-info-box">
                            ...
                            <a href="blog-detail.html"><img src="assets/images/blog_img2.jpg" class="img-fluid"
                                    alt="image"></a>
                            ...
                            <ul>
                                ...
                                <li><i class="fa fa-calendar" aria-hidden="true"></i>10 Nov 2022</li>



                                <li><a href="#"><i class="fa fa-comment-o" aria-hidden="true"></i>21
                                        Comments</a></li>
                        ...
                        <div class="blog-content">
                            ...
                            <h5><a href="blog-detail.html">On the other hand, we denounce with righteous
                                    indignation.</a></h5>
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <article class="blog-list">
                        ...
                        <div class="blog-info-box">
                            ...
                            <a href="blog-detail.html"><img src="assets/images/blog_img3.jpg" class="img-fluid"
                                    alt="image"></a>
                            ...
                            <ul>
                                ...
                                <li><i class="fa fa-calendar" aria-hidden="true"></i>05 Nov 2022</li>



                                <li><a href="#"><i class="fa fa-comment-o" aria-hidden="true"></i>18
                                        Comments</a></li>
                        ...
                        <div class="blog-content">
                            ...
                            <h5><a href="blog-detail.html">Sed ut perspiciatis unde omnis iste natus error sit
                                    voluptatem.</a></h5>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        ...
                        <ul>
                            <li><a
                                    href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">Crossovers</a>
                            </li>
                            <li><a
                                    href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">Hybrids</a>
                            </li>
                            <li><a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">Hybrid
                                    Cars</a></li>
                            <li><a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">Hybrid
                                    SUVs</a></li>
                            <li><a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">Concept
                                    Vehicles</a></li>
                        </ul>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        ...
                        <ul>
                            <li><a
                                    href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">Privacy</a>
                            </li>
                            <li><a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">Hybrid
                                    Cars</a></li>
                            <li><a
                                    href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">Cookies</a>
                            </li>
                            <li><a
                                    href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">Trademarks</a>
                            </li>
                            <li><a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">Terms of
                                    use</a></li>
                        </ul>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <h6>Useful Links</h6>
                        <ul>
                            <li><a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">Our
                                    Partners</a></li>
                            <li><a
                                    href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">Careers</a>
                            </li>
                            <li><a
                                    href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">Sitemap</a>
                            </li>
                            <li><a
                                    href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">Investors</a>
                            </li>
                            <li><a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">Request
                                    a Quote</a></li>
                        </ul>
                    </div>
                    <div class="col-md-3 col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-push-6 text-right">
                        <div class="footer_widget">
                            ...
                            <ul>
                                <li><a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#"><i
                    ...
                    <div class="col-md-6 col-md-pull-6">
                        <p class="copy-right">Copyright © 2017 CarForYou. All Rights Reserved</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--Back to top-->
    <div id="back-top" class="back-top" style="display: none;"> <a
            href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#top"><i class="fa fa-angle-up"
            ...
            <div class="modal-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <a href="#" class="btn btn-block facebook-btn"><i class="fa fa-facebook-square"
                                        aria-hidden="true"></i> Login with Facebook</a> <a href="#"
                                    class="btn btn-block twitter-btn"><i class="fa fa-twitter-square"
                                        aria-hidden="true"></i> Login with Twitter</a> <a href="#"
                                    class="btn btn-block googleplus-btn"><i class="fa fa-google-plus-square"
                ...
                <div class="modal-footer text-center">
                    <p>Don't have an account? <a href="#signupform" data-bs-toggle="modal"
                            data-bs-dismiss="modal">Signup Here</a></p>
